...
// CONFIGURACIÓN DEL CORREO QUE SE VA USAR
Configure::write('correo_dominio', "icarosistemas.es");
Configure::write('correo_host_smpt', "icarosistemas.es");
Configure::write('correo_username', "noreply@icarosistemas.es");
Configure::write('correo_password', "h5gg6s23");
Configure::write('correo_from', "info@openlove.me");
Configure::write('correo_from_name', "Openlove.me");
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniRh8k560s49X');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453542492589768425');
